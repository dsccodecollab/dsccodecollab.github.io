          ...
          <div className="w-full lg:w-6/12 px-4">
            ...
            <div className="mt-6 flex">
              <button
                ...
                type="button"
                onClick={ (e) => window.open('https://www.google.com') }
              >
                <i className="flex fab fa-twitter"></i>
              </button>
              <button
                className="bg-white text-blue-600 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 p-0 flex"
                type="button"
                onClick={ (e) => window.open('https://www.google.com') }
              >
        ...
        <div className="flex flex-wrap items-center md:justify-between justify-center">
          <div className="w-full md:w-4/12 px-4 mx-auto text-center">
            <div className="text-sm text-gray-600 font-semibold py-1">
              Copyright © {new Date().getFullYear()}{' '}The Coding Culture
            </div>
          </div>
        </div>
      </div>
